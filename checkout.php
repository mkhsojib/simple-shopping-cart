                                ...
                                <div id="confirm" class="collapse in">
                                    <div class="panel-body">
                                            ...
                                            <table class="table checkout-table">
                                                ...
                                                if ($cart->total_items() > 0){
                                                    ...
                                                    foreach ($cartItems as $item) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="item-price-col"><span
                                                                        class="item-price-special"><?php echo $item["qty"]; ?></span>
                                                            </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($cart->total_items() > 0) { ?>
                                                        <td class="checkout-table-price"><?php echo '$' . $cart->total() . ' USD'; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>

                                                    <td class="checkout-table-title" colspan="4">Shipping:</td>
                                                    <td class="checkout-table-price">0</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="text-right">
                                            <a href="cartAction.php?action=placeOrder" class="btn btn-custom-2">CONFIRM
                                                ORDER <i class="glyphicon glyphicon-menu-right"></i></a>
