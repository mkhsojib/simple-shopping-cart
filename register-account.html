            ...
            <div class="row">
                <div class="col-md-12">
                    <header class="content-title">
                        ...
                        <p class="title-desc">If you already have an account, please login at <a href="#">login page</a>.
                        </p>
                    </header>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <fieldset>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="input-icon input-icon-city"></span><span
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="state" class="form-control input-lg" id="state">
                                            <option value=" "></option>
                                            <option value="Italy">California</option>
                                            <option value="France">Narnia</option>
                                        </select>
                                    </div><!-- End .input-group -->
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <fieldset class="half-margin">
                                    ...
                                    <div class="input-desc-box">
                                        <span class="separator icon-box">&plus;</span>I wish to subscribe to the Venedor
                                        newsletter.
                                    </div><!-- End .input-desc -->
                                ...
                                <input type="submit" value="CREATE MY ACCCOUNT"
